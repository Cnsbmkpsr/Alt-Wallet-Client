    ...
    <div className="pb-12 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h1 className=" text-indigo-600 font-semibold tracking-wide uppercase text-2xl p-10">Altcoinomy Open Source Project</h1>
          ...
          <u className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto p-4">You can freely use this project as a base for your creations and projects, whether they are personal or professional.</u>
